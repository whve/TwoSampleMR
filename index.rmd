...
res<-Sort.1.to.many(res,b="b",Sort.action=4) #this sorts results by decreasing effect size (largest effect at top of the plot)
...
forest_plot_1_to_many(res,b="b",se="se",
    exponentiate=T,ao_slc=F,Lo=0.3,Up=2.5,
    TraitM="exposure",Col1_title="Risk factor",Col1_width=1.7,by=NULL,
    trans="log2",xlab="OR for CHD per SD increase in risk factor (95% confidence interval)",Addcols=c("nsnp","pval"),Addcol_widths=c(1.0,0.8),Addcol_titles=c("No. SNPs","P-val"))
```
...
forest_plot_1_to_many(res,b="b",se="se",
    exponentiate=T,ao_slc=F,Lo=0.3,Up=2.5,
    TraitM="exposure",Col1_width=1.7,by=NULL,
    trans="log2",xlab="",Addcols=c("nsnp","pval"),Addcol_widths=c(1.0,0.8),Addcol_titles=c("",""))
```
...
```{r }
res<-mr(dat2)
res<-Sort.1.to.many(res,Group="method",Sort.action=3,Priority="Inverse variance weighted")
res<-split_exposure(res) # to keep the Y axis label clean we exclude the exposure ID labels from the exposure column 

forest_plot_1_to_many(res,b="b",se="se",
	exponentiate=T,trans="log2",ao_slc=F,Lo=0.03,
	Up=22,Col1_width=1.7,by="exposure",TraitM="method",
...
forest_plot_1_to_many(res2,b="b",se="se",
	exponentiate=T,trans="log2",ao_slc=F,Lo=0.03,
	Up=22,Col1_width=1.7,by="exposure",TraitM="method",
	xlab="OR for CHD per SD increase in risk factor (95% confidence interval)")
...
res<-Sort.1.to.many(res,Sort.action=1,Group="subcategory")
forest_plot_1_to_many(res,b="b",se="se",
	exponentiate=T,trans="log2",ao_slc=F,Lo=0.3,
	Up=2.5,TraitM="Trait",Col1_width=1.2,by="subcategory",
	xlab="OR for CHD per SD increase in risk factor (95% confidence interval)")
...
combine_all_mrresults(Res,Het,Plt,Sin,ao_slc=T,Exp=F,split.exposure=F,split.outcome=T)
```
